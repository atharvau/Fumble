...
public class privatelist extends RecyclerView.Adapter<privatelist.MyViewHolder>{
    Context ctx;
...
public static String abix;
    ...
    public privatelist(ArrayList<String> RevList, Context ctx)
    {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                DownRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        abix=uri.toString();
                        Toast.makeText(ctx,abix,Toast.LENGTH_SHORT).show();
